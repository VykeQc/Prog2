...
for  ___  in ___ : # completer la boucle for pour imprimer chaque os dans la lise
    pass

print("\nListe des os windows avec boucle for : ")
for  ___  in ___ : # ajouter une condition pour que seul les os commencant par "Win sont imprimer"
    pass
